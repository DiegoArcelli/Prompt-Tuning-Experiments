...
src_tokenizer = AutoTokenizer.from_pretrained("google/t5-small")
dst_tokenizer = AutoTokenizer.from_pretrained("google/t5-small")
...
data_collator = DataCollatorForSeq2Seq(tokenizer=dst_tokenizer, model="google/t5-small")
